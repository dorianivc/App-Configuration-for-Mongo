...
import { WebResource, HttpHeaders, RequestPolicyOptions, RestError } from "@azure/core-http";
...
describe("ThrottlingRetryPolicy", () => {
    class PassThroughPolicy {
        ...
        sendRequest(request) {
            const response = Object.assign(Object.assign({}, this._response), { request: request });
    ...
    function createDefaultThrottlingRetryPolicy(response = defaultResponse, nextPolicyCreator = (response) => new PassThroughPolicy(response)) {
...
//# sourceMappingURL=throttlingRetryPolicyTests.spec.js.map