...
describe("helper methods", () => {
    ...
    describe("serializeAsConfigurationSettingParam", () => {
        [`[]`, "Hello World"].forEach((value) => {
            ...
            it(`serializer doesn't throw on ${value} as feature flag value`, () => {
                ...
                assert.deepEqual(serializeAsConfigurationSettingParam(featureFlag), featureFlag, "setting was modified");
            });
            it(`serializer doesn't throw on ${value} as secret reference value`, () => {
                ...
                setting.value = value;
                assert.deepEqual(serializeAsConfigurationSettingParam(setting), setting, "setting was modified");
            });
        });
    });
    const fakeHttp204Response = {
        _response: {
            request: {
                url: "unused",
                abortSignal: {
    ...
    it("makeConfigurationSettingEmpty", () => {
        const response = Object.assign({ key: "mykey", statusCode: 204, isReadOnly: false }, fakeHttp204Response);
    ...
    it("transformKeyValueResponse", () => {
        const configurationSetting = transformKeyValueResponse(Object.assign({ key: "hello", locked: true }, fakeHttp204Response));
        const actualKeys = Object.keys(configurationSetting).sort();
        // _response is explictly set to not enumerate, even in our copied object.
     ...
     */
    function getAllConfigurationSettingFields() {
        const configObjectWithAllFieldsRequired = {
            contentType: "",
            etag: "",
            key: "",
            label: "",
        ...
        return Object.keys(configObjectWithAllFieldsRequired).sort();
    }
    function getAllConfigurationSettingFieldsMinusKey() {
