...
describe("etags", () => {
    ...
    it("set with an old etag will throw RestError", async () => {
        ...
        // enable the etag)
        await client.setConfigurationSetting(Object.assign(Object.assign({}, addedSetting), { value: "sneaky user updated the field" }));
        // the value (and thus the etag) was changed behind our backs
        // so now this update (with the original etag) will throw.
        await assertThrowsRestError(() => client.setConfigurationSetting(addedSetting, {
            onlyIfUnchanged: true
    ...
    it("(set|clear)readonly using etags", async () => {
        ...
        await assertThrowsRestError(() => client.setReadOnly(badEtagSetting, true, {
            onlyIfUnchanged: true
        }), 412);
        ...
        await assertThrowsRestError(() => client.setReadOnly(badEtagSetting, false, {
            onlyIfUnchanged: true
        }), 412);
        // ...still readOnly
        actualSetting = await client.getConfigurationSetting(addedSetting);
