 ...
 * @azsdk-weight 20
 */
import { AppConfigurationClient, featureFlagContentType, parseFeatureFlag } from "@azure/app-configuration";
...
export async function main() {
    ...
    for (const clientFilter of newFeatureFlag.value.conditions.clientFilters) {
        clientFilter.parameters = (_a = clientFilter.parameters) !== null && _a !== void 0 ? _a : {};
        ...
        switch (clientFilter.name) {
            ...
            case "Microsoft.Targeting":
                ...
                if (isTargetingClientFilter(clientFilter)) {
                    clientFilter.parameters.Audience.Users = clientFilter.parameters.Audience.Users.concat("test2@contoso.com");
                }
                break;
